...
void test_on_edge() {
    ...
    ASSERT_TRUE(on_edge(1, 4));
    ASSERT_TRUE(on_edge(4, 1));
    ASSERT_TRUE(on_edge(2, -1));
    ASSERT_TRUE(on_edge(4, 4));
...
void test_jacobi_iteration() {
    ...
    ASSERT_EQUAL_FLOAT(local_pres0[LP(0, 0)], 1.0, 0);
    ASSERT_EQUAL_FLOAT(local_pres0[LP(4, 4)], 1.0, 0);
    ASSERT_EQUAL_FLOAT(local_pres0[LP(1, 1)], 1.5, 0);
    ASSERT_EQUAL_FLOAT(local_pres0[LP(1, 2)], 1.75, 0);
    ASSERT_EQUAL_FLOAT(local_pres0[LP(2, 2)], 2.0, 0);
    ASSERT_EQUAL_FLOAT(local_pres0[LP(3, 2)], 1.75, 0);
    ASSERT_EQUAL_FLOAT(local_pres0[LP(2, 3)], 1.75, 0);
